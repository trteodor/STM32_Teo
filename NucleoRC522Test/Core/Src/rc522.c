...
void MFRC522_Init(void)
{
	...
	ClearBitMask(Status2Reg, 0x08);		//MFCrypto1On=0   // USE this line after evry Auth
 ...
 * Return: MFRC522_OK if the bar is curved
 */
...
MFRC522_StatusHandle MFRC522_Auth(uint8_t authMode, uint8_t BlockAddr, uint8_t *Sectorkey, uint8_t *serNum)
{
    ...
    if ((status != MFRC522_OK) || (!(Read_MFRC522(Status2Reg) & 0x08)))
    {   
		status = MFRC522_Error;
	}
